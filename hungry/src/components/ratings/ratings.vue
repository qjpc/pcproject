      ...
      <div class="ratings-content">
        <div class="overview">
          <div class="overview-left">
            ...
            <div class="rank">高于周边商家{{seller.rangkRate}}%</div>
          </div>
        ...
        :only-content="onlyContent" :ratings="ratings" @selected="selectRating" @content="selectContent"></ratingselect>
...
export default {
  ...
  created(){
    axios.get('/api/ratings').then((result) => {
         this.ratings = result.data.data //  将数据存到sellerobj里  
         this.$nextTick(()=>{
