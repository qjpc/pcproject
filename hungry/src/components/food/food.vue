    ...
    <div v-show="showFlag" class="food" ref="food">
      <div class="food-content">
        ...
        <div class="rating">
          ...
          <ratingselect @selected="selectRating" @content="selectContent" :select-type="selectType" 
...
export default {
  ...
  methods:{
    show(){
      ...
      this.$nextTick(()=>{
        if(!this.scroll){  //这个判断条件意思是如果没有初始化我们就要初始化下面这个实列看是否需要滚动
  ...
  .food
    ...
    .food-content
      .image-header
        ...
        width 100%
        height 0
        padding-top 100%   //当padding设置为100%时是以当前元素的width为参考的
        img 
          position absolute
          top 0
          left 0
